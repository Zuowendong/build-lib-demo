			...
			448: (e, t, r) => {
				...
				e.exports = function (e) {
					return new Promise(function (t, r) {
						...
						function x() {
							if (E) {
								var n = "getAllResponseHeaders" in E ? u(E.getAllResponseHeaders()) : null,
									i = {
						...
						if (
							(E.open(e.method.toUpperCase(), s(w, e.params, e.paramsSerializer), !0),
							(E.timeout = e.timeout),
							"onloadend" in E
								? (E.onloadend = x)
							...
							(E.onabort = function () {
								E && (r(new l("Request aborted", l.ECONNABORTED, e, E)), (E = null));
							}),
							(E.onerror = function () {
							...
							(E.ontimeout = function () {
								...
								e.timeoutErrorMessage && (t = e.timeoutErrorMessage),
									r(new l(t, n.clarifyTimeoutError ? l.ETIMEDOUT : l.ECONNABORTED, e, E)),
									(E = null);
							}),
						...
						"setRequestHeader" in E &&
							...
							n.isUndefined(e.withCredentials) || (E.withCredentials = !!e.withCredentials),
							...
							(e.cancelToken || e.signal) &&
								((h = function (e) {
									E && (r(!e || (e && e.type) ? new p() : e), E.abort(), (E = null));
								}),
			...
			321: (e, t, r) => {
				...
				(l.prototype.request = function (e, t) {
					...
					if (
						...
						var l = [s, void 0];
						for (Array.prototype.unshift.apply(l, n), l = l.concat(u), i = Promise.resolve(t); l.length; )
		...
		const o = {
			getCat: () =>
				t()
					...
					.then((e) => ({ imageSrc: e.data.file, text: "CAT" })),
			getDog: () =>
				t()
					.get("https://random.dog/woof.json")
					.then((e) => ({ imageSrc: e.data.url, text: "DOG" })),
			getGoat: () => Promise.resolve({ imageSrc: "https://placegoat.com/200", text: "GOAT" }),
		};
	})(),
		(AnimalApi = n);
})();
